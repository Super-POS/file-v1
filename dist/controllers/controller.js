...
const extract_buffer_1 = require("../shared/files/extract.buffer");
    ...
    constructor() {
        ...
        this.base64 = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { buffer, ext, mimetype } = (0, extract_buffer_1.parseImageBase64)(req.body.image);
                ...
                if (yield verifyFile(filePath)) {
                    const file = (0, image_payload_1.default)(fileName, filePath, buffer, mimetype);
